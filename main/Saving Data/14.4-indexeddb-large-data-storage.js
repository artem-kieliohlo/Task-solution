// Сохранение больших объемов данных настороне клиента с помощью IndexedDB
// Задача 
// Нам нужно более сложное хранилище данных на стороне клиента, чем то, что
// предоставляет localStorage.
